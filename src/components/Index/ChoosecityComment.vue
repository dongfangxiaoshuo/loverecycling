  ...
  <div class="choosecity">
    ...
    <section class="indexbar">
      <van-index-bar :index-list="indexList" >
        <div v-for="city_list in national_cities" v-bind:key="city_list.id">
          <div v-if="city_list.title!='#'">
            <van-index-anchor :index="city_list.title">{{city_list.title}}</van-index-anchor>
            <van-cell v-for="city_item in city_list.lists" v-bind:key="city_item.id" :title="city_item" />
          </div>
          <div v-else>
